...
const faqs = [
  {
    q: "Do you provide IT services across all of Fujairah?",
    a: "Yes. We serve clients across Fujairah City, Dibba Al Fujairah, Dibba Al Hisn, Khor Fakkan, Kalba, Masafi, and the Fujairah Free Zone. We cover the entire east coast of the UAE.",
  },
  {
  ...
  },
  {
    ...
    a: "For AMC clients in Fujairah, we typically achieve on-site response within 4–8 hours depending on location. For critical systems we prioritise same-day dispatch from our nearest engineer.",
  },
  {
    q: "Do you work with Fujairah Free Zone companies?",
    a: "Yes. We have experience with Fujairah Free Zone (FFZ) and Creative City Fujairah businesses, providing IT infrastructure and managed services compliant with free zone standards.",
  },
  {
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6">
                ...
                <span className="text-sm font-semibold text-primary">Serving Fujairah</span>
              </div>
              ...
              <div className="flex gap-3 flex-wrap">
                <Link href="/contact">
                  <Button className="bg-gradient-to-r from-primary to-rose-500 text-white" data-testid="button-fujairah-cta">
                    Request Free Site Survey <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
                </Link>
                <a href="tel:+97148864215">
                  <Button variant="outline" className="border-gray-300 text-gray-700" data-testid="button-fujairah-call">
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}>
              <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-gray-300/30 border border-gray-100">
                <img
                  src="https://images.unsplash.com/photo-1587474260584-136574528ed5?w=800&h=500&fit=crop&q=80"
                  alt="Fujairah IT Solutions"
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-4 shadow-lg">
                    <p className="text-sm font-semibold text-gray-900">Trusted across Fujairah</p>
                    <p className="text-xs text-gray-500 mt-0.5">Fujairah City · Khor Fakkan · Dibba · Kalba · Fujairah Free Zone</p>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-16 md:py-20 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-3">IT Services in Fujairah</h2>
            <p className="text-gray-500 max-w-xl mx-auto">Complete technology solutions for Fujairah businesses — from port facilities to hotels and free zone companies.</p>
          </div>
      ...
      <section className="py-12 bg-gray-50 px-4 md:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Areas We Cover in Fujairah</h2>
          <div className="flex flex-wrap justify-center gap-3">
            {["Fujairah City", "Khor Fakkan", "Dibba Al Fujairah", "Dibba Al Hisn", "Kalba", "Masafi", "Fujairah Free Zone", "Creative City Fujairah", "Al Faseel", "Al Gurfa", "Mirbah", "Qidfa"].map(area => (
      ...
      <FAQSection
        title="IT Services Fujairah — FAQs"
        subtitle="Common questions from Fujairah businesses about our services."
        faqs={faqs}
        ctaText="Request Fujairah Site Survey"
      />

      <section className="py-16 px-4 md:px-8 bg-white border-t border-gray-100">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-3">Start Your Fujairah IT Project</h2>
          <p className="text-gray-600 mb-6">Get a free consultation from our certified engineers — we'll visit your Fujairah site and deliver a proposal within 24 hours.</p>
          <div className="flex gap-3 justify-center flex-wrap">
            <Link href="/contact">
              <Button className="bg-primary text-white" data-testid="button-fujairah-final-cta">Book Free Consultation</Button>
            </Link>
            <a href="https://wa.me/97148864215" target="_blank" rel="noreferrer">
              <Button variant="outline" className="border-gray-300" data-testid="button-fujairah-whatsapp">
