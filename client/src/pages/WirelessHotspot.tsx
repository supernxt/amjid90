      ...
      <div className="pt-32 pb-20 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {[
              { icon: Wifi, title: "High-Speed Connectivity", desc: "Up to 10 Gbps throughput" },
              { icon: Shield, title: "Enterprise Security", desc: "WPA3 & advanced encryption" },
              { icon: Zap, title: "Zero Downtime", desc: "99.99% uptime guarantee" },
              { icon: Users, title: "Massive Capacity", desc: "1000+ concurrent users" },
            ].map((feature, index) => (
              <motion.div
                key={index}
          ...
          >
            <Button size="lg" className="gap-2" onClick={openAIChat} data-testid="button-get-started">
