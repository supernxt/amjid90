...
const faqs = [
  {
    q: "Do you provide IT services across all of Ajman?",
    a: "Yes. We serve clients across Ajman City, Al Jurf Industrial Area, Al Rashidiya, Al Hamidiya, Al Nuaimia, Al Rawda, Al Rumaila, Al Mowaihat, and the Ajman Free Zone.",
  },
  {
    q: "What is your response time for on-site support in Ajman?",
    a: "For AMC clients in Ajman, our standard SLA is 4 hours for critical issues and next business day for non-critical requests. Our proximity to Dubai allows rapid deployment to Ajman sites.",
  },
  {
  ...
  },
  {
    ...
    a: "Absolutely. We have delivered infrastructure projects for factories, warehouses, and manufacturing plants in Ajman's industrial areas. We handle projects from 50 to 5,000+ cabling points.",
  },
  {
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6">
                ...
                <span className="text-sm font-semibold text-primary">Serving Ajman</span>
              </div>
              ...
              <div className="flex gap-3 flex-wrap">
                <Link href="/contact">
                  <Button className="bg-gradient-to-r from-primary to-rose-500 text-white" data-testid="button-ajman-cta">
                    Request Free Site Survey <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
                </Link>
                <a href="tel:+97148864215">
                  <Button variant="outline" className="border-gray-300 text-gray-700" data-testid="button-ajman-call">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-gray-300/30 border border-gray-100">
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-4 shadow-lg">
                    <p className="text-sm font-semibold text-gray-900">Trusted across Ajman</p>
                    <p className="text-xs text-gray-500 mt-0.5">Al Jurf · Al Rashidiya · Al Nuaimia · Ajman Free Zone · Industrial Area</p>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-16 md:py-20 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-3">IT Services in Ajman</h2>
            <p className="text-gray-500 max-w-xl mx-auto">Complete technology solutions for Ajman businesses — from consultation to installation and ongoing support.</p>
          </div>
      ...
      <section className="py-12 bg-gray-50 px-4 md:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Areas We Cover in Ajman</h2>
          <div className="flex flex-wrap justify-center gap-3">
            {["Ajman City", "Al Jurf", "Al Rashidiya", "Al Hamidiya", "Al Nuaimia", "Al Rawda", "Al Rumaila", "Al Mowaihat", "Ajman Free Zone", "Ajman Industrial Area", "Al Ameera Village", "Al Helio"].map(area => (
      ...
      <FAQSection
        title="IT Services Ajman — FAQs"
        subtitle="Common questions from Ajman businesses about our services."
        faqs={faqs}
        ctaText="Request Ajman Site Survey"
      />

      <section className="py-16 px-4 md:px-8 bg-white border-t border-gray-100">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-3">Start Your Ajman IT Project</h2>
          <p className="text-gray-600 mb-6">Get a free consultation from our certified engineers — we'll visit your Ajman site and deliver a proposal within 24 hours.</p>
          <div className="flex gap-3 justify-center flex-wrap">
            <Link href="/contact">
              <Button className="bg-primary text-white" data-testid="button-ajman-final-cta">Book Free Consultation</Button>
            </Link>
            <a href="https://wa.me/97148864215" target="_blank" rel="noreferrer">
              <Button variant="outline" className="border-gray-300" data-testid="button-ajman-whatsapp">
