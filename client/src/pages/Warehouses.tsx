...
import { Wifi, Cable, Headphones, Bot, Shield, CheckCircle, ArrowRight, Phone, MessageSquare, Package } from "lucide-react";
...
const services = [
  ...
  { icon: Shield, title: "Access Control", desc: "IP-based door access control for restricted zones, high-value storage areas, and staff entry — integrated with your HR and visitor management systems.", color: "bg-violet-50 text-violet-600" },
  { icon: Headphones, title: "IT AMC Support", desc: "Maintenance contracts covering all network, WiFi, and access control equipment with fast on-site response and 24/7 remote monitoring.", color: "bg-emerald-50 text-emerald-600" },
...
const faqs = [
  ...
  },
  {
    ...
    a: "Yes. We have experience installing IT infrastructure, WiFi, and structured cabling in JAFZA, DAFZA, RAKEZ, and other UAE free zone warehouses. We handle all approvals and work within free zone contractor requirements.",
  },
  {
    q: "Do you offer a maintenance contract for warehouse IT systems?",
    a: "Yes. Our warehouse IT AMC covers all installed systems — WiFi, structured cabling, and access control. Includes quarterly preventive maintenance, 24/7 remote monitoring, and fast on-site response for faults affecting operations.",
  },
];
...
const schema = {
  ...
  description: "Industrial WiFi, structured cabling, access control, and managed IT for warehouses and logistics facilities across UAE.",
...
export default function Warehouses() {
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Warehouse IT Solutions UAE | Industrial WiFi & Access Control | Super Next Technologies"
        description="IT solutions for warehouses and logistics facilities in UAE — industrial WiFi, access control, structured cabling, and managed IT. Serving JAFZA, DAFZA, and all UAE free zones."
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Super Next Technologies provides industrial WiFi, access control, structured cabling, and managed IT for warehouses, logistics hubs, and distribution centres across the UAE.
              </p>
              <ul className="grid grid-cols-2 gap-3 mb-8">
                {["Industrial WiFi coverage", "Ruggedised access points", "Access control systems", "Free zone experience", "24/7 monitoring", "Fast on-site response"].map(item => (
      ...
      <section className="py-16 px-4 md:px-8 bg-white border-t border-gray-100">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-gray-600 mb-6">Our engineers will visit your warehouse, survey the space, and deliver a complete proposal for WiFi, cabling, and access control — free of charge.</p>
