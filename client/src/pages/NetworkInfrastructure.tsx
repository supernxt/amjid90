...
const networkSchema = {
  ...
  "description": "Enterprise networking solutions: Cisco, Juniper, MikroTik implementation, network security, firewalls, VPN, LAN/WAN design, and 24/7 NOC monitoring across UAE.",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }}>
              ...
              <p className="text-xl text-gray-600 max-w-xl mb-8">
                Enterprise-grade Cisco, Juniper, and MikroTik networking solutions for businesses across UAE. LAN/WAN design, firewalls, VPN, and 24/7 network monitoring.
              </p>
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }} className="hidden lg:block">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-gray-300/50">
                ...
                <div className="absolute bottom-6 left-6 text-white">
                  ...
                  <p className="text-sm text-white/80">Enterprise Networking across UAE</p>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.7 }} className="mb-16">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 mt-2">Network engineers deployed across UAE</p>
            </div>
