    ...
    <Background3D variant="web">
      <div className="pt-32 pb-20 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-green-400 via-primary to-emerald-500 bg-clip-text text-transparent">
              Website Development
            </h1>
            <p className="text-xl md:text-2xl text-foreground/80 max-w-3xl mx-auto">
              Modern, responsive websites that captivate and convert
            </p>
          </motion.div>
